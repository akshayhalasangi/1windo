...
{	
	#20 Colors
	$ColorsArray = array("#ff8c69","#b4babe","#9b887d","#f5e2d0","#7c8491","#8cb33e","#2d7fc8","#cf3a3b","#d9001d","#2c768a","#4c9186","#62bcaa","#349f69","#0d194d","#d4bfe0","#5da9b5","#b8a061","#8c61df","#ff6b6b","#13d4d8");
...
function getOrderName($Type,$OrderID)
	{
		return '#ORD'.$Type.str_pad($OrderID, 7, "0", STR_PAD_LEFT); 
	}
