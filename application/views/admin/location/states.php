                                ...
                                <div class="col-lg-12 ks-panels-column-section">
                                    ...
                                    <div class="card panel ks-information ks-lightc ks-permission">
                                        <h5 class="card-header">
                                            <span class="ks-text">States List</span>
                                            <a href="<?= admin_url('Location/state/0'); ?>" class="btn btn-outline-primary ks-light"><i class="fa fa-plus"></i> New State</a>
                                        </h5>
                                                    ...
                                                    <?php $key = 0; foreach($country as $i => $module) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="ks-controls">
                                                                <div class="dropdown">
                                                                    <a class="btn btn-link" id="dropdownMenu<?= $module['name']; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                        <span class="la la-ellipsis-h"></span>
                                                                    </a>
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu<?= $module['id']; ?>">
                                                                        <a class="dropdown-item" href="<?= admin_url('Location/state/'.$module['id'].'/'.$module['country_id']); ?>"><?= _l('txt_edit' ); ?></a>
