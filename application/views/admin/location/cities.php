                                ...
                                <div class="col-lg-12 ks-panels-column-section">
                                    ...
                                    <div class="card panel ks-information ks-lightc ks-permission">
                                        <h5 class="card-header">
                                            <span class="ks-text">City List</span>
                                            <a href="<?= admin_url('Location/city/0'); ?>" class="btn btn-outline-primary ks-light"><i class="fa fa-plus"></i> New City</a>
                                        </h5>
                                                            ...
                                                            <td class="ks-controls">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu<?= $module['id']; ?>">
                                                                        <a class="dropdown-item" href="<?= admin_url('Location/city/'.$module['id']); ?>"><?= _l('txt_edit' ); ?></a>
