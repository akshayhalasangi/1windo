        ...
        <div class="ks-page-header">
            <section class="ks-title">
                <h3>
                    <?php
                        if(!empty($attribute)){
                            echo ("Edit: ".$attribute->A_Title." - ");
                        }
                        echo _l('txt_products_attributes');
                    ?>
                </h3>
                
                <button class="btn btn-outline-primary ks-light mt-2" onclick="window.location.href='<?= admin_url('Products/Attributes') ?>'"><i class="fa fa-chevron-left"></i> <?= _l('btn_go_back'); ?></button>
            </section>
        </div>
                                    ...
                                    <div class="card panel">
                                        <div class="card-block">
                                            ...
                                            <form method="POST" action="" class="has-validation-callback" id="attribute-form" onsubmit="return true"  enctype="multipart/form-data"> 
                                                ...
                                                <?= render_input( 'Val_Atitle', 'add_edit_title',$value,'text',$attrs,array(),'','','','','','',true,'','','',$data_atts,''); ?>
                                                ...
                                                <?= render_input( 'Val_Adescription', 'add_edit_description',$value,'text',$attrs,array(),'','','','','','',true,'','','',$data_atts,''); ?>
                                               <div class="form-group">
													<label for="Val_Level" class="form-control-label"><?= _l('add_edit_type'); ?></label>
													<div class="">
