                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <?php if(!empty($Profile)){ ?>
                                     <h4 id="form-validation-basic-demo"><?= _l('Edit Delivery Boy Account'); ?></h4>
                                    <?php } else { ?>
                                    ...
                                    <div class="card panel">
                                        <div class="card-block">
                                            ...
                                            ?>
                                            <form method="POST" action="" class="has-validation-callback" id="deliveryboy-account-form" onsubmit="return true"  enctype="multipart/form-data"> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <button type="button" onclick="window.location.href='<?= admin_url('DeliveryBoys');?>'" class="btn btn-outline-primary ks-light"><?= _l('btn_back'); ?></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
