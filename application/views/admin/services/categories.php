    ...
    <div class="ks-column ks-page">
        <div class="ks-page-header">
            <section class="ks-title">
                <h3><?= _l('txt_service_categories')?></h3>
            </section>
        </div>
                ...
                <div class="ks-nav-body">
                    <div class="ks-nav-body-wrapper">
                        ...
                        <div class="row serviceCategories">
                            ...
                            <?php                             
                                $categoryGroups = $servicesCategoryList;
                                
                                if(count($categoryGroups)>0 && $categoryGroups != null)
                                {    
                                    $subCatFlag = false;
                                    foreach($categoryGroups['Categories'] as $key => $categories) {

                                        if($key == "MainCategory"){
                                            echo "<h3> Main Service Categories </h3><div class='col-md-12 divider'><div class='row'>";
                                ...
                                function displayCategories($catDetails, $catName, $key, $index){
                                    ?>
                                        <div class="col-md-2 services">
                                            <a href="<?= admin_url('Services/serviceList/'.$catDetails['CategoryID']);?>">
                                                <?php if(strlen(trim($catDetails['C_DisplayIcon'])) <= 0){ ?>
                                                    <img src="<?= DEFAULT_IMG_URL; ?>" class="avatar" alt="Services">
                                                <?php } else { ?>
                                                    <img src="<?= UPLOAD_CATEGORIES_BASE_URL.$catDetails['CategoryID']."/".$catDetails['C_DisplayIcon']; ?>" class="avatar" alt="Services">
                                                <?php } ?>
