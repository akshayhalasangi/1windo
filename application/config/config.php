...
if(file_exists(APPPATH.'config/app-config.php')){
    ...
    $install_url .= 'install';
    echo '<h1>1Windo not installed</h1>';
    echo '<p>1. To you use the automatic installation tool click <a href="'.$install_url.'">here ('.$install_url.')</a></p>';
...
$config['base_url'] = 'http://localhost/1Windo/';
...
| can opt to set a specific path as well:
|*/
//echo APP_BASE_URL.'application/vendor/facebook/php-sdk-v4/src/Facebook/autoload.php';exit();
 //   $config['composer_autoload'] = APP_BASE_URL.'/application/vendor/facebook/php-sdk-v4/src/Facebook/autoload.php';
