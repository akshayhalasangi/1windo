    ...
    public function Fetch()
    {
        ...
        if(!empty($data['Action']) && $data['Action'] == 'GetAllVendors'){
            ...
            if ($VendorsArray) {
                ...
                $result = array('status'=>'success','flag'=>'1','message'=>'Vendors Records Fetched','data'=>$Records);
            } elseif ($TechsArray === FALSE) {
                $result = array('status'=>'error','flag'=>'2','message'=>'No entry found.');
            }
        } else if(!empty($data['Action']) && $data['Action'] == 'SingleVendor'){
            ...
            if( !empty($data['Val_Vendor']) && $data['Val_Vendor'] != '') {
                ...
                if ($VendorData) {
                    ...
                    $VendorJobs = $this->Jobs_model->getJoined(NULL,array(TBL_JOBS.'.VendorID'=>$data['Val_Vendor']),false);
                    ...
                    $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Record Fetched','data'=>$Records);
                } elseif ($VendorArray === FALSE) {
                    $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Record Not Fetched','data'=>$data['Val_Vendor']);
                }
            } else {
            ...
            if( !empty($data['Val_Vendor']) && $data['Val_Vendor'] != '') {
                ...
                if ($VendorData) {
                    ...
                    $WorksData = $this->Vendors_model->getWorks(NULL,array('W_VendorID'=>$data['Val_Vendor']));
                    $LocationsData = $this->Vendors_model->getLocations(NULL,array('L_VendorID'=>$data['Val_Vendor']));
                    ...
                    $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Record Fetched','data'=>$Record);
                } elseif ($VendorArray === FALSE) {
                    $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Record Not Fetched','data'=>(object)array());
                }
            } else {
                $result = array('status'=>'info','flag'=>'4','message'=>'Parameters Missing.');
            }
            ...
            if( !empty($data['Val_Vendor']) && $data['Val_Vendor'] != '' ) {
                ...
                if ($VendorData) {
                    ...
                    if(!empty($ProfileData)){
                        ...
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Profile Record Fetched','data'=>$Record);
            ...
            if( !empty($data['Val_Vendor']) && $data['Val_Vendor'] != '' ) {
                ...
                if ($VendorData) {
                    ...
                    if(!empty($AboutData)){
                        ...
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor About Record Fetched','data'=>$Record);
        ...
        } else if(!empty($data['Action']) && $data['Action'] == 'GetWorksDetails'){
            ...
            if( !empty($data['Val_Vendor']) && $data['Val_Vendor'] != '' ) {
                ...
                if ($VendorData) {
                    ...
                    if(!empty($WorksData)){
                        ...
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Work Record Fetched','data'=>$Record);
            ...
            if( !empty($data['Val_Vendor']) && $data['Val_Vendor'] != '' ) {
                ...
                if ($VendorData) {
                    ...
                    $LocationData = $this->Vendors_model->getLocations(NULL,array('L_VendorID'=>$data['Val_Vendor']));
                    ...
                    if(!empty($LocationData)){
                        ...
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Location Record Fetched','data'=>$Record);
...
//					if ($success || $Asuccess) {}
                if ($success) {
                    $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Profile Updated Successfully','data'=>$Record);
                } else if ($success == false) {
                    $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Profile Not Updated','data'=>$data['Val_Vendor']);
                }
                else{
...
//					if ($success || $Asuccess) {}
                if (!empty($success) && !is_array($success) && $success == true) {
                    $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Profile Image Updated Successfully','data'=>$Record);
                } else if ((is_array($success) && $success['flag'] == '1' ) || empty($success)) {
                    $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Profile Image Not Updated','data'=>$success);
                }
                else{
                    $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>$success);
                }
        ...
        else if( !empty($data) && $data['Action'] == 'UpdateIdentity' ) {
            if( !empty($data['Val_Vendor'])  && !empty($data['Val_Type']))
            {
                ...
                if(!empty($ProfileData)){
                    ...
                    else if( $data['Val_Type'] == '3')
                    {
                        $data['Val_Pcurrentstatus'] = '2';
                    }
                    else if( $data['Val_Type'] == '4')
                    {
                    ...
                    if ($success) {
                        ...
                        $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Profile Not Updated','data'=>$Record);
                    }
                    else{
        ...
        else if( !empty($data) && $data['Action'] == 'UpdateAbout' ) {
            if( !empty($data['Val_Vendor']))
            {
                ...
                if(!empty($AboutData)){
                    ...
                    if ($success) {
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor About Updated Successfully','data'=>$Record);
                    } else if ($success == false) {
                        $result = array('status'=>'error','flag'=>'2','message'=>'Vendor About Not Updated','data'=>$Record);
                    }
                    else{
                        $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>(object)array());
                    }
        ...
        else if( !empty($data) && $data['Action'] == 'UpdateWorks' ) {
            if( !empty($data['Val_Vendor']))
            {
                ...
                if(!empty($WorksData)){
                    ...
                    if ($success) {
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Works Updated Successfully','data'=>$Record);
                    } else if ($success == false) {
                        $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Works Not Updated','data'=>$Record);
                    }
                    else{
                        $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>(object)array());
                    }
            ...
            if( !empty($data['Val_Vendor']))
            {
                ...
                if(!empty($LocationData)){
                    ...
                    if ($success) {
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Location Updated Successfully','data'=>$Record);
                    } else if ($success == false) {
                        $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Location Not Updated','data'=>$Record);
                    }
                    else{
                        $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>(object)array());
                    }
        ...
        else if( !empty($data) && $data['Action'] == 'DeleteWorkImage' ){
            ...
            if( !empty($data['Val_Vendor']))
            {
                ...
                if(!empty($WorksData)){
                    ...
                    if ($success) {
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Works Image Delete Successfully','data'=>(object)array());
                    } else if ($success == false) {
                        $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Works Image Not Delete','data'=>(object)array());
                    }
                    else{
                        $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>(object)array());
                    }
        ...
        else if( !empty($data) && $data['Action'] == 'SubmitForApproval' ) {
            if(!empty($data['Val_Vendor'])  )
            {
                ...
                if ($success) {
                    $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Profile Submitted Successfully','data'=>$Record);
                } else if ($success == false) {
                    $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Profile Not Submitted ','data'=>(object)array());
                }
                else{
                    $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>(object)array());
                }
                ...
                $result = array('status'=>'info','flag'=>'4','message'=>'Parameter Missing...','data'=>(object)array());
            }

        }
        else if(!empty($data) && $data['Action'] == 'VerificationStatus' )
        {
            if(!empty($data['Val_Vendor'])  )
            {
                $VendorData = $this->Vendors_model->getVendor($data['Val_Vendor']);
            ...
            if( !empty($data['Val_Vendor']))
            {
                ...
                if(!empty($AccountData)){
                    ...
                    if ($success) {
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Account Updated Successfully','data'=>$Record);
                    } else if ($success == false) {
                        $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Account Not Updated','data'=>$Record);
                    }
                    else{
                        $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>(object)array());
                    }
...
//					if ($success || $Asuccess) {}
        ...
        /*		else if( !empty($data) && $data['Action'] == 'UpdateLocation' ) {
            ...
            if( !empty($data['Val_Vendor']) && !empty($data['Val_Aname']) && !empty($data['Val_Alatitude']) && !empty($data['Val_Alongitude']) && !empty($data['Val_Aaddress']) && !empty($data['Val_Alocation'])  ) {
                ...
                if ($success) {
                    $VendorData = $this->Vendors_model->getVendor($data['Val_Vendor']);
                    $AddressArray = $this->Vendors_model->getAddresses(NULL,array('A_VendorID'=>$data['Val_Vendor']));
            ...
            if( !empty($data['Val_Vendor']) && !empty($data['Val_Address']) && !empty($data['Val_Aname']) && !empty($data['Val_Alatitude']) && !empty($data['Val_Alongitude']) && !empty($data['Val_Aaddress']) && !empty($data['Val_Alocation'])  ) {
                ...
                $success = $this->Vendors_model->updateAddress($data,$data['Val_Address']);
                ...
                if (!empty($VendorData) && !empty($AddressData)) {
                    ...
                    $AddressArray = $this->Vendors_model->getAddresses(NULL,array('A_RelationID'=>$VendorData->VendorID));
            ...
            if ($success ) {
                $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Address Deleted Successfully','data'=>$Record);
            } else if ($success == false) {
                $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Address Not Deleted','data'=>$Record);
            }
            else{
                $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>$success);
            }
            ...
            if ($success || $Asuccess) {
                $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Profile Deleted Successfully','data'=>'Confidential');
            } else if ($success == false && $Asuccess == false) {
                $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Profile Not Deleted','data'=>$data['Val_Vendor']);
            }
            else{
                $result = array('status'=>'warning','flag'=>'3','message'=>'Something Important','data'=>$success);
            }
            ...
            if(!empty($data['Val_Vendor']))
            {
                ...
                if(!empty($VendorData))
                {
                    ...
                    if(!empty($CategoryData))
                    {
                        ...
                        $OrdersArray1 =  $this->Cart_model->getCartTotal(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'4','C_Status'=>'3')," DATE(C_BookedDttm) <= '$month_line_1' AND  DATE(C_BookedDttm) >= '$LastMonthDate' ");

                        //10th
                        $month_line_2 = date('Y-m-d',strtotime($LastMonthDate." +9 day"));
                        $OrdersArray2 =  $this->Cart_model->getCartTotal(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'4','C_Status'=>'3')," DATE(C_BookedDttm) <= '$month_line_2' AND  DATE(C_BookedDttm) > '$month_line_1' ");

                        //15th
                        $month_line_3 = date('Y-m-d',strtotime($LastMonthDate." +14 day"));
                        $OrdersArray3 =  $this->Cart_model->getCartTotal(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'4','C_Status'=>'3')," DATE(C_BookedDttm) <= '$month_line_3' AND  DATE(C_BookedDttm) > '$month_line_2' ");
                        //20th
                        $month_line_4 = date('Y-m-d',strtotime($LastMonthDate." +19 day"));
                        $OrdersArray4 =  $this->Cart_model->getCartTotal(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'4','C_Status'=>'3')," DATE(C_BookedDttm) <= '$month_line_4' AND  DATE(C_BookedDttm) > '$month_line_3' ");
                        //25th
                        $month_line_5 = date('Y-m-d',strtotime($LastMonthDate." +24 day"));
                        $OrdersArray5 =  $this->Cart_model->getCartTotal(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'4','C_Status'=>'3')," DATE(C_BookedDttm) <= '$month_line_5' AND  DATE(C_BookedDttm) > '$month_line_4' ");
                        //last day of month
                        $month_line_last = date('Y-m-d',strtotime($LastMonthDate." next month - 1 hour"));
                        $OrdersArraylast =  $this->Cart_model->getCartTotal(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'4','C_Status'=>'3')," DATE(C_BookedDttm) <= '$month_line_last' AND  DATE(C_BookedDttm) > '$month_line_5' ");
                        ...
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Dashboard Data Fetched','data'=>$Records);
            ...
            if(!empty($data['Val_Vendor']))
            {
                ...
                if(!empty($VendorData))
                {
                    ...
                    if(!empty($CategoryData))
                    {
                        ...
                        $Type = $data['Val_Type'];
                        if($BusinessType == '1'){
                            $OrdersArray =  $this->Cart_model->get(NULL,array('C_AssignedTo'=>$data['Val_Vendor'],'C_OrderStatus'=>'1','C_Status'=>'3'));
                            if($Type == '1'){
                            ...
                            $OrdersArray =  $this->Cart_model->getProductsCart(NULL,array('PC_AssignedTo'=>$data['Val_Vendor'],'PC_OrderStatus'=>'1','PC_Status'=>'3'));
                            if($Type == '1'){
                            ...
                            $OrdersArray =  $this->Cart_model->getRestaurantsCart(NULL,array('RC_AssignedTo'=>$data['Val_Vendor'],'RC_OrderStatus'=>'1','RC_Status'=>'3'));
                            if($Type == '1'){
...
*/
                        ...
                        $Records['MiscData'] 					= $MiscRecords;
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Revenue Data Fetched','data'=>$Records);
            ...
            if( !empty($data['Val_Type']) && $data['Val_Type'] == 1 && !empty($data['Val_Vendor']) && !empty($data['Val_Option']) && !empty($data['Val_Address']) && !empty($data['Val_Date']) && !empty($data['Val_Timeslab']) )
            {
                ...
                //print_r($VendorData);
                $VendorFullName 	= getStringValue($VendorData->C_FirstName)." ".getStringValue($VendorData->C_LastName);
                $VendorAddress 	= array(getStringValue($VendorData->C_Address),getStringValue($VendorData->C_Location));
...
//    private $cart_data = array( 'C_OrderStatus'=>'Val_Corderstatus', 'C_Status'=>'Val_Cstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
            ...
            else if( !empty($data['Val_Type']) && $data['Val_Type'] == 2 && !empty($data['Val_Vendor']) && !empty($data['Val_Product']) )
            {

                $ExistingCartArray	=  $this->Cart_model->getProductsCart(NULL,array('PC_Status <>'=>'3','PC_Status <>'=>'4','PC_VendorID'=>$data['Val_Vendor']));
...
//						}
            ...
            else if( !empty($data['Val_Type']) && $data['Val_Type'] == 3 && !empty($data['Val_Vendor']) && !empty($data['Val_Restaurant']) && !empty($data['Val_Food']) )
            {

                $ExistingCartArray	=  $this->Cart_model->getRestaurantsCart(NULL,array('RC_Status <>'=>'3','RC_Status <>'=>'4','RC_VendorID'=>$data['Val_Vendor']));
...
//    private $cart_data = array( 'C_OrderStatus'=>'Val_Corderstatus', 'C_Status'=>'Val_Cstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
            ...
            else if( !empty($data['Val_Type']) && $data['Val_Type'] == 3 && !empty($data['Val_Cart']) && !empty($data['Val_Food']) && !empty($data['Val_Quantity']) && !empty($data['Val_Vendor']) && !empty($data['Val_Restaurant']) )
            {
...
//    private $cart_data = array( 'C_OrderStatus'=>'Val_Corderstatus', 'C_Status'=>'Val_Cstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
            ...
            else if( !empty($data['Val_Type']) && $data['Val_Type'] == 3 && !empty($data['Val_Cart']) && !empty($data['Val_Restaurant'])  && !empty($data['Val_Vendor']) && !empty($data['Val_Food']) )
            {
                $ExistingCartData	=  $this->Cart_model->getRestaurantsCart($data['Val_Cart']);
                $ExistingCartDetailData	=  $this->Cart_model->getRestaurantsCartDetails(NULL,array('RD_CartID'=>$data['Val_Cart'],'RD_FoodID'=>$data['Val_Food']));
                if(!empty($ExistingCartData) && !empty($ExistingCartDetailData) && count($ExistingCartDetailData) == '1')
...
//    private $cart_data = array( 'C_OrderStatus'=>'Val_Corderstatus', 'C_Status'=>'Val_Cstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
            ...
            else if( !empty($data['Val_Type']) && $data['Val_Type'] == 2 && !empty($data['Val_Vendor']) && !empty($data['Val_Cart']) && !empty($data['Val_Address']) && !empty($data['Val_Cpaymentoption']) && !empty($data['Val_Cservicecharge']) && !empty($data['Val_Ctotal']) )
            {
...
//    private $cart_data = array( 'C_OrderStatus'=>'Val_Corderstatus', 'C_Status'=>'Val_Cstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
            ...
            else if( !empty($data['Val_Type']) && $data['Val_Type'] == 3 && !empty($data['Val_Vendor']) && !empty($data['Val_Cart']) && !empty($data['Val_Address']) && !empty($data['Val_RCpaymentoption']) && !empty($data['Val_RCservicecharge']) && !empty($data['Val_RCtotal']) )
            {
                unset($data['Val_Type']);
            ...
            if(  !empty($data['Val_Vendor']) )
            {
                ...
                $ExistingRestaurantCartArray =  $this->Cart_model->getRestaurantsCart(NULL,array('RC_OrderStatus'=>'0','RC_Status <>'=>'3','RC_Status <>'=>'4','RC_VendorID'=>$data['Val_Vendor']));
            ...
            if( !empty($data['Val_Vendor']) )
            {
                ...
                $ExistingServiceCartArray		=  $this->Cart_model->get(NULL,array('C_OrderStatus'=>'0','C_Status <>'=>'3','C_Status <>'=>'4','C_VendorID'=>$data['Val_Vendor']));
                $ExistingProductCartArray		=  $this->Cart_model->getProductsCart(NULL,array('PC_OrderStatus'=>'0','PC_Status <>'=>'3','PC_Status <>'=>'4','PC_VendorID'=>$data['Val_Vendor']));
                $ExistingRestaurantCartArray	=  $this->Cart_model->getRestaurantsCart(NULL,array('RC_OrderStatus'=>'0','RC_Status <>'=>'3','RC_Status <>'=>'4','RC_VendorID'=>$data['Val_Vendor']));
            ...
            if( !empty($data['Val_Vendor']) )
            {
                ...
                if(!empty($VendorData))
                {
                    ...
                    if(!empty($CategoryData))
                    {
                        ...
                        $Records['MiscData'] 			= $MiscRecords;
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Orders Data Fetched','data'=>$Records);
                ...
                if(!empty($VendorData))
                {
                    ...
                    if(!empty($CategoryData))
                    {
                        ...
                        if($BusinessType == '1'){
                            ...
                            $OrderData =  $this->Cart_model->get($data['Val_Order'],array('C_AssignedTo'=>$data['Val_Vendor']));

                        } else if($BusinessType == '2'){
                            $OrderData =  $this->Cart_model->getProductsCart($data['Val_Order'],array('PC_AssignedTo'=>$data['Val_Vendor']));


                        } else if($BusinessType == '3'){
                            $OrderData =  $this->Cart_model->getRestaurantsCart($data['Val_Order'],array('RC_AssignedTo'=>$data['Val_Vendor']));
                        ...
                        if(!empty($OrderData))
                        {
                            ...
                            if(!empty($OrderData->CartID)){
                                ...
                                $OrderType		= '1';
                                $OrderName		= getOrderName('1',$OrderID);
                                $OrderDate		= date('Y-m-d',strtotime($OrderData->C_BookedDttm));
                                $OrderTime		= date('H:i',strtotime($OrderData->C_BookedDttm));
                                $OrderTimeAgo	= time_ago($OrderData->C_AssignedDttm);
                            ...
                            $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Orders Data Fetched','data'=>$Record);
                        }
                        else
                        {
                            $result = array('status'=>'error','flag'=>'2','message'=>'Vendor Orders Data Not Found','data'=>(object)$Record);
                        }
            ...
            if( !empty($data['Val_Vendor']) )
            {
                ...
                if(!empty($VendorData))
                {
                    ...
                    if(!empty($CategoryData))
                    {
                        ...
                        $ReviewsArray =  $this->Vendors_model->getReviews(NULL,array('R_VendorID'=>$data['Val_Vendor']));
...
//													$ReviewData = (object)$ReviewArray;
                        ...
                        $Records['MiscData'] 		= $MiscRecords;
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Reviews Data Fetched','data'=>$Records);
            ...
            if( !empty($data['Val_Vendor']) )
            {
                ...
                if(!empty($VendorData))
                {
                    ...
                    if(!empty($CategoryData))
                    {
                        ...
                        $AccountArray =  $this->Vendors_model->getAccounts(NULL,array('A_VendorID'=>$data['Val_Vendor']));
                        ...
                        $Records['MiscData'] 		= $MiscRecords;
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Account Data Fetched','data'=>$Records);
...
//											'BusinessLocationStatus'		=> $BusinessLocationStatus,
                        ...
                        $Records['MiscData'] 		= $MiscRecords;
                        $result = array('status'=>'success','flag'=>'1','message'=>'Vendor Profile Data Fetched','data'=>$Records);
