...
class Services extends Admin_Controller
{
    ...
    {
        $data['title'] = _l('title_services');
        $data['listAssets'] = 'true';

        $this->load->model('Categories_model');
        $servicesCategoryList = $this->Categories_model->getCategory(null, array("C_Type" => SERVICE_CATEGORY_ID), 'ASC', 'C_Parent');
        $CategoryHierarchy = $this->Categories_model->getCategoryHierarchy(SERVICE_CATEGORY_ID);

        $data['servicesCategoryList']['Categories'] = displayCategoryHierarchy($servicesCategoryList, $CategoryHierarchy);

        $this->load->view(SERVICE_URL . 'categories', $data);
    }
