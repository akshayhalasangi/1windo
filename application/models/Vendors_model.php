...
{ 
    private $vendor_data = array('VendorID'=>'Val_Vendor', 'V_FirstName'=>'Val_Vfirstname', 'V_LastName'=>'Val_Vlastname', 'V_Email'=>'Val_Vemailaddress', 'V_CountryCode'=>'Val_Vcountrycode', 'V_Mobile'=>'Val_Vmobilenumber', 'V_Gender'=>'Val_Vgender', 'V_ProfileImage'=>'Val_Vprofileimage', 'V_CategoryID'=>'Val_Category', 'V_Latitude'=>'Val_Vlatitude', 'V_Longitude'=>'Val_Vlongitude', 'V_Address'=>'Val_Vaddress', 'V_Location'=>'Val_Vlocation', 'V_City'=>'Val_Vcity', 'V_Country'=>'Val_Vcountry', 'V_VerificationMessage'=>'Val_Vverificationmessage','V_ProfileStatus'=>'Val_Vprofilestatus',  'V_VerificationStatus'=>'Val_Vverificationstatus',  'V_Status'=>'Val_Vstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');

	private $profile_data = array('VProfileID'=>'Val_Profile','P_VendorID'=>'Val_Vendor', 'P_IDCardType'=>'Val_Pidcardtype', 'P_IDCardName'=>'Val_Pcardname', 'P_IDCardNumber'=>'Val_Pidcardnumber', 'P_IDCardFrontImage'=>'Val_Pidcardfrontimage', 'P_IDCardBackImage'=>'Val_Pidcardbackimage', 'P_IDCardStatus'=>'Val_Pidcardstatus', 'P_GuardianName'=>'Val_Pguardianname', 'P_Gender'=>'Val_Pgender', 'P_BirthDate' => 'Val_Pbirthdate', 'P_PermanentBuilding' => 'Val_Ppermanentbuilding','P_PermanentLocality'=>'Val_Ppermanentlocality', 'P_PermanentCity' => 'Val_Ppermanentcity', 'P_PermanentState' => 'Val_Ppermanentstate','P_PermanentPincode'=>'Val_Ppermanentpincode', 'P_PersonalStatus'=>'Val_Ppersonalstatus', 'P_CurrentBuilding' => 'Val_Pcurrentbuilding', 'P_CurrentLocality' => 'Val_Pcurrentlocality','P_CurrentCity'=>'Val_Pcurrentcity', 'P_CurrentState' => 'Val_Pcurrentstate', 'P_CurrentPincode' => 'Val_Pcurrentpincode', 'P_CurrentStatus'=>'Val_Pcurrentstatus', 'P_TermsStatus'=>'Val_Ptermsstatus','P_Status'=>'Val_Pstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');

	private $about_data = array('VAboutID'=>'Val_About','A_VendorID'=>'Val_Vendor', 'A_BusinessName'=>'Val_Abusinessname', 'A_BusinessPresence'=>'Val_Abusinesspresence', 'A_ProfileLink'=>'Val_Aprofilelink', 'A_FacebookLink'=>'Val_Afacebooklink', 'A_WorkLinks'=>'Val_Aworklinks', 'A_PhoneNumber'=>'Val_Aphonenumber', 'A_Type'=>'Val_Atype', 'A_ExperienceYear'=>'Val_Aexperienceyear', 'A_ExperienceMonth' => 'Val_Aexperiencemonth', 'A_Introduction' => 'Val_Aintroduction','A_StartingPrice'=>'Val_Astartingprice', 'A_Specialization' => 'Val_Aspecialization','A_Status'=>'Val_Astatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');


	private $work_data = array('VWorkID'=>'Val_Work','W_VendorID'=>'Val_Vendor', 'W_WorksGallery'=>'Val_Wworksgallery','W_Status'=>'Val_Wstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');

	private $location_data = array('VLocationID'=>'Val_Location','L_VendorID'=>'Val_Vendor', 'L_Location'=>'Val_Llocation', 'L_Latitude'=>'Val_Llatitude', 'L_Longitude'=>'Val_Llongitude', 'L_Radius'=>'Val_Lradius','L_Status'=>'Val_Lstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
	...
	private $account_data = array('VAccountID'=>'Val_Account','A_VendorID'=>'Val_Vendor', 'A_GSTName'=>'Val_Agstname', 'A_GSTNumber'=>'Val_Agstnumber', 'A_AccountName'=>'Val_Aaccountname', 'A_AccountType'=>'Val_Aaccounttype', 'A_AccountNumber'=>'Val_Aaccountnumber', 'A_IFSCNumber'=>'Val_Aifscnumber', 'A_Status'=>'Val_Astatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
        ...
        if ($vendor) {
            ...
            if ($this->db->affected_rows() > 0) {
               // $this->load->model('emails_model');
                ...
                $send = $this->emails_model->send_enquiry_email($email,'Forgot Password','We received a request to reset your 1Windo password. Click the below button to choose a new one. Your new password is'.$new_pass_key ,'ForgotPassword',$vendor->C_FullName); 
             //return true;
