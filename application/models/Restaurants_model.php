...
class Restaurants_model extends W_Model
{
    ...
    private $restaurant_data = array(
        'RestaurantID' => 'Val_Restaurant', 'R_FoodCategoryID' => 'Val_FoodCategory', 'R_Name' => 'Val_Rname',
        'R_Description' => 'Val_Rdescription', 'R_FeaturedImage' => 'Val_Rfeaturedimage',
        'R_Latitude' => 'Val_RLatitude', 'R_Longitude' => 'Val_RLongitude', 'R_Address' => 'Val_RAddress',
        'R_City' => 'Val_RCity', 'R_Area' => 'Val_RArea', 'R_Neighborhood' => 'Val_RNeighborhood',
        'R_Country' => 'Val_RCountry', 'R_DeliveryTime' => 'Val_Rdeliverytime', 'R_PriceforTwo' => 'Val_Rpricefortwo',
        'R_Sales' => 'Val_Rsales', 'R_Rating' => 'Val_Rrating', 'R_Status' => 'Val_Rstatus', 'RowAddedDttm' => '',
        'RowUpdatedDttm' => ''
    );

    private $foods_data = array(
        'RFoodID' => 'Val_Feature', 'F_CategoryID' => 'Val_Category', 'F_RestaurantID' => 'Val_Restaurant',
        'F_Title' => 'Val_Ftitle', 'F_Description' => 'Val_Fdescription', 'F_Price' => 'Val_Fprice',
        'F_DisplayImage' => 'Val_Fdisplayimage', 'F_Type' => 'Val_Ftype', 'F_Recommended' => 'Val_Frecommended',
        'F_Status' => 'Val_Fstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => ''
    );

    private $reviews_data = array(
        'ReviewID' => 'Val_Review', 'R_Type' => 'Val_Type', 'R_RelationID' => 'Val_Restaurant',
        'R_VendorID' => 'Val_Vendor', 'R_MemberID' => 'Val_Member', 'R_UserName' => 'Val_Rusername',
        'R_Comment' => 'Val_Rcomment', 'R_Location' => 'Val_Rlocation', 'R_Rating' => 'Val_Rrating',
        'R_Date' => 'Val_Rdate', 'R_Status' => 'Val_Rstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => ''
    );
        ...
        if ($rowcount > 0) {
            ...
            switch ($result->S_IsAdmin) {
                case 0:
                    ...
                    break;
                case 1:
                    $this->db->where('R_Area', $result->Area);
                    $this->db->order_by('RestaurantID', $orderby);
                    $result = $this->db->get(TBL_RESTAURANTS)->result_array();
                    break;
            }
