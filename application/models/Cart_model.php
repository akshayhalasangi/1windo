...
{
    private $cart_data = array('CartID'=>'Val_Cart',  'C_CustomerID'=>'Val_Customer','C_CustomerName'=>'Val_Ccustomername','C_CustomerAddress'=>'Val_Ccustomeraddress', 'C_ServiceID'=>'Val_Service', 'C_ServiceNames'=>'Val_Cservicenames', 'C_PackageID'=>'Val_Package', 'C_PackageNames'=>'Val_Cpackagenames', 'C_OptionID'=>'Val_Option', 'C_OptionNames'=>'Val_Coptionnames', 'C_OptionPrices'=>'Val_Coptionprices', 'C_AddressID'=> 'Val_Address', 'C_Date'=>'Val_Cdate', 'C_TimeslabID'=>'Val_Ctimeslab', 'C_Timeslab'=>'Val_Ctimeslabtitle', 'C_PaymentOption'=>'Val_Cpaymentoption', 'C_ServiceCharge'=>'Val_Cservicecharge', 'C_Total'=>'Val_Ctotal', 'C_OrderStatus'=>'Val_Corderstatus', 'C_Status'=>'Val_Cstatus', 'C_AssignedTo'=>'Val_Cassginedto', 'C_BookedDttm' => 'Val_Cbookeddttm', 'C_AcceptedDttm' => 'Val_Caccepteddttm', 'C_ProcessingDttm' => 'Val_Cprocessingdttm', 'C_DeliveredDttm' => 'Val_Cdelivereddttm', 'C_CancelledDttm' => 'Val_Ccancelleddttm', 'C_AssignedDttm' => 'Val_Cassigneddttm', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');

    private $product_cart_data = array('PCartID'=>'Val_Cart', 'PC_CustomerID'=>'Val_Customer','PC_CustomerName'=>'Val_PCcustomername','PC_CustomerAddress'=>'Val_PCcustomeraddress', 'PC_ProductID'=>'Val_Product', 'PC_ProductNames'=>'Val_PCproductnames',  'PC_Date'=>'Val_PCdate', 'PC_DetailID'=>'Val_PCdetail', 'PC_Prices'=>'Val_PCprices','PC_AddressID'=>'Val_Address', 'PC_ItemTotal'=>'Val_PCitemtotal', 'PC_DeliveryCharge'=>'Val_PCdeliverycharges', 'PC_CartTotal'=>'Val_PCcarttotal', 'PC_PaymentOption'=>'Val_PCpaymentoption', 'PC_ServiceCharge'=>'Val_PCservicecharge', 'PC_Total'=>'Val_PCtotal', 'PC_OrderStatus'=>'Val_PCorderstatus', 'PC_Status'=>'Val_PCstatus', 'PC_AssignedTo'=>'Val_PCassginedto', 'PC_DeliveryBy'=>'Val_PCdeliveryby', 'PC_DeliveryByStatus'=>'Val_PCdeliverybystatus', 'PC_BookedDttm' => 'Val_PCbookeddttm', 'PC_AcceptedDttm' => 'Val_PCaccepteddttm', 'PC_ProcessingDttm' => 'Val_PCprocessingdttm', 'PC_DeliveredDttm' => 'Val_PCdelivereddttm', 'PC_CancelledDttm' => 'Val_PCcancelleddttm', 'PC_AssignedDttm' => 'Val_PCassigneddttm', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
    ...
    private $restaurant_cart_data = array('RCartID'=>'Val_Cart', 'RC_CustomerID'=>'Val_Customer','RC_CustomerName'=>'Val_RCcustomername','RC_CustomerAddress'=>'Val_RCcustomeraddress', 'RC_RestaurantID'=>'Val_Restaurant', 'RC_RestaurantName'=>'Val_RCrestaurantname',  'RC_Date'=>'Val_RCdate', 'RC_DetailID'=>'Val_RCdetail', 'RC_Prices'=>'Val_RCprices','RC_AddressID'=>'Val_Address', 'RC_ItemCount'=>'Val_RCitemcount', 'RC_ItemTotal'=>'Val_RCitemtotal', 'RC_DeliveryCharge'=>'Val_RCdeliverycharges', 'RC_CartTotal'=>'Val_RCcarttotal', 'RC_PaymentOption'=>'Val_RCpaymentoption', 'RC_ServiceCharge'=>'Val_RCservicecharge', 'RC_Total'=>'Val_RCtotal', 'RC_OrderStatus'=>'Val_RCorderstatus', 'RC_Status'=>'Val_RCstatus', 'RC_AssignedTo'=>'Val_RCassginedto', 'RC_DeliveryBy'=>'Val_RCdeliveryby', 'RC_DeliveryByStatus'=>'Val_RCdeliverybystatus', 'RC_BookedDttm' => 'Val_RCbookeddttm', 'RC_AcceptedDttm' => 'Val_RCaccepteddttm', 'RC_ProcessingDttm' => 'Val_RCprocessingdttm', 'RC_DeliveredDttm' => 'Val_RCdelivereddttm', 'RC_CancelledDttm' => 'Val_RCcancelleddttm', 'RC_AssignedDttm' => 'Val_RCassigneddttm', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');

    private $restaurant_cart_details_data = array('CRDetailID'=>'Val_Cartdetail', 'RD_CartID'=>'Val_Cart','RD_FoodID'=>'Val_Food','RD_Quantity'=>'Val_RDquantity', 'RD_Price'=>'Val_RDprice', 'RowAddedDttm' => '', 'RowUpdatedDttm' => '');
...
//		$this->db->where('PC_Status NOT IN (3,4)');
     ...
     * @return array
     */
	public function getProductsCartDetails($cartdetail_id = '', $where = array() ,$orderby = 'DESC')
	{		
		$this->db->where($where);
     ...
     * @return array
     */
	public function getRestaurantsCart($cart_id = '', $where = array(), $wherestring = '' ,$orderby = 'DESC')
	{		
		$this->db->where($where);
		if(!empty($wherestring))
			$this->db->where($wherestring);
...
//		echo $this->db->last_query();
     ...
     * @return array
     */
	public function getRestaurantsCartTotal($cart_id = '', $where = array() ,$wherestring = '',$orderby = 'DESC')
	{
     ...
     * @return array
     */
	public function getRestaurantsCartDetails($cartdetail_id = '', $where = array() ,$orderby = 'DESC')
	{
     ...
     * Add new category to database
     */
    public function addCartProducts($data)
	{      	
     ...
     * Add new category to database
     */
    public function addCartProductsDetails($data)
	{      	
     ...
     * Add new category to database
     */
    public function addCartRestaurants($data)
	{      	
     ...
     * Add new category to database
     */
    public function addCartRestaurantsDetails($data)
	{      	
     ...
     * Update category informations
     */
    public function updateCartProducts($data, $cartproductid)
    {
		$affectedRows = 0;
        $product_cart_data = array();
        foreach ($this->product_cart_data as $dbfield => $field) {
     ...
     * Update category informations
     */
    public function updateCartProductsDetails($data, $cartproductdetailid)
    {
		$affectedRows = 0;
        $product_cart_details_data = array();
        foreach ($this->product_cart_details_data as $dbfield => $field) {
     ...
     * Update category informations
     */
    public function removeDeliveryBoyCartProducts($cartproductid)
    {
		$affectedRows = 0;
		$data[''] 		= '2';
     ...
     * Update category informations
     */
    public function updateCartRestaurants($data, $cartrestaurantid)
    {
		$affectedRows = 0;
        $restaurant_cart_data = array();
     ...
     * Update category informations
     */
    public function updateCartRestaurantsDetails($data, $cartrestaurantdetailid)
    {
     ...
     * Update category informations
     */
    public function removeDeliveryBoyCartRestaurants($cartrestaurantid)
    {
		$affectedRows = 0;
		$data[''] 		= '2';
     ...
     * Delete Category
     */
	public function deleteCartProductsDetails($id)
	{
     ...
     * Delete Category
     */
	public function deleteCartRestaurants($id)
	{
     ...
     * Delete Category
     */
	public function deleteCartRestaurantsDetails($id)
	{
	...
	public function getServiceOngoingOrders($id)
	{
		$this->db->select('*');
	 ...
	 public function getServicePastOrders($id){
		$this->db->select('*');
		$this->db->from('1w_tbl_cart_service');
		$this->db->where('C_AssignedTo',$id);
	...
	public function getProductsOngoingOrders($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_product');
	...
	public function getProductsPastOrders($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_product');
		$this->db->where('PC_AssignedTo',$id);
	...
	public function getRestaurantsOngoingOrders($id)
	{
		$this->db->select('*');
	...
	public function getRestaurantsPastOrders($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_restaurant');
		$this->db->where('RC_AssignedTo',$id);
	...
	public function getRestaurantsPastOrdersData($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_restaurant');
		$this->db->where('RC_AssignedTo',$id);
	...
	public function getServicePastOrdersData($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_service');
		$this->db->where('C_AssignedTo',$id);
	...
	public function getProductsPastOrdersData($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_product');
		$this->db->where('PC_AssignedTo',$id);
	...
	public function getDProductsOrdersData($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_product');
	...
	public function getDRestaurantsOrdersData($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_restaurant');
	...
	public function getDProductsOngoingOrders($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_product');
		$this->db->where('PC_DeliveryBy',$id);
	...
	public function getDRestaurantsOngoingOrders($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_restaurant');
		$this->db->where('RC_DeliveryBy',$id);
	...
	public function getDProductsOrdersHistory($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_product');
		$this->db->where('PC_DeliveryBy',$id);
	...
	public function getDRestaurantsOrdersHistory($id)
	{
		$this->db->select('*');
        $this->db->from('1w_tbl_cart_restaurant');
		$this->db->where('RC_DeliveryBy',$id);
