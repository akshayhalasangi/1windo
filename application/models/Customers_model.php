...
class Customers_model extends W_Model
{
    private $customer_data = array(
        'CustomerID' => 'Val_Customer', 'C_FirstName' => 'Val_Cfirstname', 'C_LastName' => 'Val_Clastname',
        'C_Email' => 'Val_Cemailaddress', 'C_CountryCode' => 'Val_Ccountrycode', 'C_Mobile' => 'Val_Cmobilenumber',
        'C_Gender' => 'Val_Cgender', 'C_ProfileImage' => 'Val_Cprofileimage', 'C_Latitude' => 'Val_Clatitude',
        'C_Longitude' => 'Val_Clongitude', 'C_Address' => 'Val_Caddress', 'C_Location' => 'Val_Clocation',
        'C_City' => 'Val_Ccity', 'C_Status' => 'Val_Cstatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => ''
    );
        ...
        if ($customer) {
            ...
            if ($this->db->affected_rows() > 0) {
                ...
                $send = $this->emails_model->send_enquiry_email($email, 'Forgot Password',
                    ...
                    'ForgotPassword', $customer->C_FullName);
                //return true;
