...
class Staffs_model extends W_Model
{
    private $admin_data = array(
        'S_FirstName' => 'Val_FirstName', 'S_LastName' => 'Val_LastName', 'S_Email' => 'Val_Email',
        'S_Password' => 'Val_Password', 'S_IsAdmin' => 'Val_IsAdmin', 'S_IsActive' => 'Val_IsActive',
        'S_IsStatus' => 'Val_IsStatus', 'RowAddedDttm' => '', 'RowUpdatedDttm' => ''
    );
    ...
    public function addMember($data)
    {
        if (!empty($data)) {
            ...
            if ($AEmailExist >= 1) {
                ...
                if ($result->S_IsAdmin == 1) {
                    $admin_data['Area'] = $result->Area;
                }
