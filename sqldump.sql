...
CREATE TABLE `1w_tbl_addresses` (
  ...
  `A_RelationID` int(11) NOT NULL,
  `A_Name` text NOT NULL,
  `A_Address` text NOT NULL,
  `A_Location` text NOT NULL,
  `A_Latitude` varchar(20) NOT NULL,
  `A_Longitude` varchar(20) NOT NULL,
  `A_Status` enum('1','2','3') NOT NULL,
  `RowAddedDttm` datetime NOT NULL,
...
CREATE TABLE `1w_tbl_cart_product` (
  ...
  `PC_CustomerName` text NOT NULL,
  `PC_CustomerAddress` text NOT NULL,
  `PC_ProductID` varchar(100) NOT NULL,
  `PC_ProductNames` varchar(100) NOT NULL,
  `PC_Date` date NOT NULL,
  `PC_DetailID` varchar(100) NOT NULL,
  `PC_Prices` varchar(100) NOT NULL,
  `PC_AddressID` int(11) NOT NULL,
  `PC_ItemTotal` float(10,2) NOT NULL,
  `PC_DeliveryCharge` float(10,2) NOT NULL,
  `PC_CartTotal` float(10,2) NOT NULL,
  `PC_PaymentOption` enum('1','2') DEFAULT NULL,
  `PC_ServiceCharge` float(10,2) NOT NULL,
  `PC_Total` float(10,2) NOT NULL,
  `PC_OrderStatus` enum('0','1','2','3','4','5','6') NOT NULL DEFAULT '0' COMMENT '0 = Pending, 1 = Booked, 2 = Accepted, 3 = Processing, 4 = Delivered, 5 = Cancelled, 6 - Assigned',
  `PC_Status` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 = Added, 2 = updated , 3 = Completed , 4 = Cancelled',
  `PC_AssignedTo` int(11) NOT NULL,
  `PC_DeliveryBy` int(11) DEFAULT NULL,
  `PC_DeliveryByStatus` enum('0','1','2','3','4') NOT NULL DEFAULT '0' COMMENT '0 - Pending, 1 - Assigned, 2 - Accepted, 3 - Pickedup, 4 - Delivererd',
  `PC_BookedDttm` datetime DEFAULT NULL,
  `PC_AcceptedDttm` datetime DEFAULT NULL,
  `PC_ProcessingDttm` datetime DEFAULT NULL,
  `PC_DeliveredDttm` datetime DEFAULT NULL,
  `PC_CancelledDttm` datetime DEFAULT NULL,
  `PC_AssignedDttm` datetime DEFAULT NULL,
...
CREATE TABLE `1w_tbl_cart_product_details` (
  ...
  `PD_AttributeID` int(11) NOT NULL,
  `PD_AttribValueID` int(11) NOT NULL,
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_cart_restaurant` (
  ...
  `RC_CustomerName` text NOT NULL,
  `RC_CustomerAddress` text NOT NULL,
  `RC_RestaurantID` varchar(100) NOT NULL,
  `RC_RestaurantName` varchar(100) NOT NULL,
  `RC_Date` date NOT NULL,
  `RC_DetailID` varchar(100) NOT NULL,
  `RC_Prices` varchar(100) NOT NULL,
  `RC_AddressID` int(11) NOT NULL,
  `RC_ItemCount` int(11) NOT NULL,
  `RC_ItemTotal` float(10,2) NOT NULL,
  `RC_DeliveryCharge` float(10,2) NOT NULL,
  `RC_CartTotal` float(10,2) NOT NULL,
  `RC_PaymentOption` enum('1','2') DEFAULT NULL,
  `RC_ServiceCharge` float(10,2) NOT NULL,
  `RC_Total` float(10,2) NOT NULL,
  `RC_OrderStatus` enum('0','1','2','3','4','5','6') NOT NULL DEFAULT '0' COMMENT '0 = Pending, 1 = Booked, 2 = Accepted, 3 = Processing, 4 = Delivered, 5 = Cancelled, 6 - Assigned',
  `RC_Status` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 = Added, 2 = updated , 3 = Completed , 4 = Cancelled',
  `RC_AssignedTo` int(11) NOT NULL,
  `RC_DeliveryBy` int(11) NOT NULL,
  `RC_DeliveryByStatus` enum('0','1','2','3','4') NOT NULL DEFAULT '0' COMMENT '0 - Pending, 1 - Assigned, 2 - Accepted, 3 - Pickedup, 4 - Delivererd',
  `RC_BookedDttm` datetime DEFAULT NULL,
  `RC_AcceptedDttm` datetime DEFAULT NULL,
  `RC_ProcessingDttm` datetime DEFAULT NULL,
  `RC_DeliveredDttm` datetime DEFAULT NULL,
  `RC_CancelledDttm` datetime DEFAULT NULL,
  `RC_AssignedDttm` datetime DEFAULT NULL,
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`RCartID`)
...
CREATE TABLE `1w_tbl_cart_restaurant_details` (
  ...
  `RD_FoodID` int(11) NOT NULL,
  `RD_Quantity` int(11) NOT NULL,
  `RD_Price` float(10,2) NOT NULL,
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdateDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_cart_service` (
  ...
  `C_CustomerName` text NOT NULL,
  `C_CustomerAddress` text NOT NULL,
  `C_ServiceID` int(11) NOT NULL,
  `C_ServiceNames` varchar(100) NOT NULL,
  `C_PackageID` text NOT NULL,
  `C_PackageNames` text NOT NULL,
  `C_OptionID` text NOT NULL,
  `C_OptionNames` text NOT NULL,
  `C_OptionPrices` text NOT NULL,
  `C_AddressID` int(11) NOT NULL,
  `C_Date` date NOT NULL,
  `C_TimeslabID` int(11) NOT NULL,
  `C_Timeslab` varchar(20) NOT NULL,
  `C_PaymentOption` enum('1','2') DEFAULT NULL,
  `C_ServiceCharge` varchar(10) NOT NULL,
  `C_Total` varchar(20) NOT NULL,
  `C_OrderStatus` enum('0','1','2','3','4','5','6') NOT NULL DEFAULT '0' COMMENT '0 = Pending, 1 = Booked, 2 = Accepted, 3 = Processing, 4 = Delivered, 5 = Cancelled, 6 = Assigned',
  `C_Status` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 = Added, 2 = updated , 3 = Completed , 4 = Cancelled',
  `C_AssignedTo` int(11) NOT NULL,
  `C_BookedDttm` datetime DEFAULT NULL,
  `C_AcceptedDttm` datetime DEFAULT NULL,
  `C_ProcessingDttm` datetime DEFAULT NULL,
  `C_DeliveredDttm` datetime DEFAULT NULL,
  `C_CancelledDttm` datetime DEFAULT NULL,
  `C_AssignedDttm` datetime DEFAULT NULL,
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`CartID`)
...
CREATE TABLE `1w_tbl_categories` (
  ...
  `C_Type` enum('1','2','3') NOT NULL COMMENT '1 = Service, 2 = Product, 3 = Food',
  `C_Level` int(11) NOT NULL,
  `C_Parent` int(11) NOT NULL,
  `C_DisplayImage` text NOT NULL,
  `C_DisplayIcon` text NOT NULL,
  `C_Featured` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1 = no, 2 - yes',
  `C_Status` enum('1','2','3','') NOT NULL DEFAULT '2' COMMENT '1 = Pending, 2 = Enable, 3 = Disable',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_countries` (
  ...
  `CountryName` varchar(80) CHARACTER SET latin1 NOT NULL,
  `CountryNiceName` varchar(80) CHARACTER SET latin1 NOT NULL,
  `CountryISO3` char(3) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `1w_tbl_customers` (
  ...
  `C_CountryCode` varchar(200) NOT NULL,
  `C_Mobile` varchar(255) NOT NULL,
  `C_Gender` varchar(255) DEFAULT NULL COMMENT '1: Male, 2 : Female',
  `C_ProfileImage` mediumtext,
  `C_Latitude` varchar(25) NOT NULL,
  `C_Longitude` varchar(25) NOT NULL,
  `C_Address` text,
  `C_Location` text NOT NULL,
  `C_City` varchar(200) NOT NULL,
  `C_Status` enum('1','2','3','4') NOT NULL DEFAULT '2' COMMENT '1: Pending , 2 : Enable, 3 : Disable,4:Mark as Violated',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_delivery_boys` (
  ...
  `DB_LastName` varchar(100) NOT NULL,
  `DB_Email` varchar(255) NOT NULL,
  `DB_CountryCode` varchar(200) NOT NULL,
  `DB_Mobile` varchar(255) NOT NULL,
  `DB_ProfileImage` mediumtext,
  `DB_Latitude` varchar(25) NOT NULL,
  `DB_Longitude` varchar(25) NOT NULL,
  `DB_Address` text,
  `DB_Location` text NOT NULL,
  `DB_City` varchar(200) NOT NULL,
  `DB_Country` varchar(100) DEFAULT NULL,
  `DB_ProfileStatus` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 = Pending, 2 - Submitted, 3 - Approved, 4 - Rejected',
  `DB_Status` enum('1','2','3','4') NOT NULL DEFAULT '2' COMMENT '1: Pending , 2 : Enable, 3 : Disable,4:Mark as Violated',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_deliveryboy_accounts` (
  ...
  `A_AccountName` text,
  `A_AccountType` enum('1','2','0') DEFAULT '0' COMMENT '1 - Saving, 2 - Current',
  `A_AccountNumber` text COMMENT '1 - Pending,2 - Submitted,3- Approved, 4 - Rejected',
  `A_IFSCNumber` text,
  `A_Status` enum('1','2','3') NOT NULL DEFAULT '1' COMMENT '1 = Pending, 2 = Enable, 3 = Disable',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdateDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`DBAccountID`),
...
CREATE TABLE `1w_tbl_members` (
  ...
  `M_Mobile` mediumtext NOT NULL,
  `M_Password` mediumtext NOT NULL,
  `M_Type` enum('1','2','3') NOT NULL COMMENT '1 = Customer, 2 = Vendor, 3 = DeliveryBoy',
  `RelationID` int(11) NOT NULL,
  `M_AndroidToken` mediumtext,
  `M_iOSToken` mediumtext NOT NULL,
  `M_Status` enum('1','2') NOT NULL COMMENT '1 = Deactive, 2 = Active',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_notifications` (
  ...
  `N_Action_Type` enum('1','2','3','4','5','6') NOT NULL COMMENT '1: Register User, 2: Update Profile, 3 : Report,4:Request,5:Comment,6:Like',
  `N_RelationID` int(11) NOT NULL,
  `N_IsRead` enum('1','2') NOT NULL DEFAULT '2' COMMENT '1:Read,2:Unread',
  `N_Description` text NOT NULL,
  `N_Subject` varchar(255) NOT NULL,
  `N_FromUserID` int(11) NOT NULL,
  `N_ToUserID` int(11) NOT NULL,
  `N_UserType` enum('1','2','3') NOT NULL COMMENT '1:Admin , 2: User',
  `N_Date` datetime NOT NULL,
  `RowAddedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_products` (
  ...
  `P_FeaturedImage` text NOT NULL,
  `P_Gallery` text NOT NULL,
  `P_Price` float(10,2) NOT NULL,
  `P_Attributes` text NOT NULL,
  `P_AttributeValues` text NOT NULL,
  `P_Sales` int(11) NOT NULL,
  `P_Rating` int(11) NOT NULL,
  `P_Featured` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1 = no, 2 - yes',
  `P_Status` enum('1','2','3','4') NOT NULL DEFAULT '1',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_products_attributes` (
  ...
  `A_Status` enum('1','2','3','4') NOT NULL DEFAULT '1',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_products_attributes_values` (
  ...
  `V_Status` enum('1','2','3','4') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_restaurants` (
  ...
  `R_FeaturedImage` text NOT NULL,
  `R_Latitude` varchar(25) NOT NULL,
  `R_Longitude` varchar(25) NOT NULL,
  `R_Address` varchar(255) NOT NULL,
  `R_City` varchar(30) DEFAULT NULL,
  `R_Area` varchar(150) DEFAULT NULL,
  `R_Neighborhood` varchar(150) DEFAULT NULL,
  `R_Country` varchar(8) NOT NULL,
  `R_Search_Area` varchar(250) DEFAULT NULL,
  `R_DeliveryTime` text NOT NULL,
  `R_PriceforTwo` float(10,2) NOT NULL,
  `R_Sales` int(11) NOT NULL,
  `R_Rating` float(4,2) NOT NULL,
  `R_Featured` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1 = no, 2 - yes',
  `R_Status` enum('1','2','3','4') NOT NULL DEFAULT '1',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_restaurants_foods` (
  ...
  `F_RestaurantID` int(11) NOT NULL,
  `F_Title` varchar(100) NOT NULL,
  `F_Description` text NOT NULL,
  `F_Price` float(10,2) NOT NULL,
  `F_DisplayImage` text NOT NULL,
  `F_Type` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1 = Veg,2 Non-Veg',
  `F_Recommended` enum('1','2') NOT NULL DEFAULT '1' COMMENT ' 1 - no, 2 - yes',
  `F_Status` enum('1','2','3') NOT NULL DEFAULT '1',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`RFoodID`),
...
CREATE TABLE `1w_tbl_reviews` (
  ...
  `R_RelationID` int(11) NOT NULL,
  `R_VendorID` int(11) NOT NULL,
  `R_MemberID` int(11) NOT NULL,
  `R_UserName` text NOT NULL,
  `R_Comment` text NOT NULL,
  `R_Location` text NOT NULL,
  `R_Rating` varchar(10) NOT NULL,
  `R_Date` date NOT NULL,
  `R_Time` time NOT NULL,
  `R_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_services` (
  ...
  `S_DisplayImage` text NOT NULL,
  `S_DisplayIcon` text NOT NULL,
  `S_Featured` enum('1','2') NOT NULL DEFAULT '1' COMMENT '1 = no, 2 - yes',
  `S_Status` enum('1','2','3') NOT NULL DEFAULT '2' COMMENT '1 = Pending, 2 = Enable, 3 = Disable',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `1w_tbl_services_features` (
  ...
  `F_Description` text NOT NULL,
  `F_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`SFeatureID`),
...
CREATE TABLE `1w_tbl_services_packages` (
  ...
  `P_Description` text NOT NULL,
  `P_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`SPackageID`),
...
CREATE TABLE `1w_tbl_services_packages_options` (
  ...
  `O_PackageID` int(11) NOT NULL,
  `O_Title` text NOT NULL,
  `O_Price` text NOT NULL,
  `O_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`SPOptionID`),
...
CREATE TABLE `1w_tbl_services_steps` (
  ...
  `ST_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`SStepID`),
...
CREATE TABLE `1w_tbl_services_timeslabs` (
  ...
  `T_EndTime` time NOT NULL,
  `T_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`STimeslabID`),
...
CREATE TABLE `1w_tbl_services_works` (
  ...
  `W_DisplayImage` text NOT NULL,
  `W_Status` enum('1','2','3') NOT NULL DEFAULT '2',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`SWorkID`),
...
CREATE TABLE `1w_tbl_staffs` (
  ...
  `S_LastLogin` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `S_LastPasswordChange` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `S_NewPassKey` varchar(255) NOT NULL,
...
CREATE TABLE `1w_tbl_vendor_about` (
  ...
  `A_BusinessName` text,
  `A_BusinessPresence` enum('1','2','3','4','0') NOT NULL DEFAULT '0' COMMENT '1 - Website, 2 - Certificate, 3 -  Online, 4 - None',
  `A_ProfileLink` text,
  `A_FacebookLink` text,
  `A_WorkLinks` longtext COMMENT '1 - Pending,2 - Submitted,3- Approved, 4 - Rejected',
  `A_PhoneNumber` varchar(20) DEFAULT NULL,
  `A_Type` enum('1','2','0') DEFAULT NULL COMMENT '1 - Company, 2 - Freelancer',
  `A_ExperienceYear` varchar(10) DEFAULT NULL,
  `A_ExperienceMonth` varchar(10) DEFAULT NULL,
  `A_Introduction` longtext,
  `A_StartingPrice` float(10,2) DEFAULT NULL,
  `A_Specialization` longtext,
  `A_Status` enum('1','2','3') NOT NULL DEFAULT '1' COMMENT '1 = Pending, 2 = Enable, 3 = Disable',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdateDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`VAboutID`),
...
CREATE TABLE `1w_tbl_vendor_locations` (
  ...
  `L_Location` text,
  `L_Latitude` varchar(20) DEFAULT NULL,
  `L_Longitude` varchar(20) DEFAULT NULL,
  `L_Radius` varchar(10) DEFAULT NULL,
  `L_Status` enum('1','2','3','4') NOT NULL DEFAULT '1',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdateDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`VLocationID`),
...
CREATE TABLE `1w_tbl_vendor_profiles` (
  ...
  `P_IDCardType` enum('1','2','3','0') DEFAULT '0' COMMENT '1 - Voters card, 2 - Driving card, 3 - Pan Card',
  `P_IDCardName` varchar(100) DEFAULT NULL,
  `P_IDCardNumber` varchar(20) DEFAULT NULL,
  `P_IDCardFrontImage` text,
  `P_IDCardBackImage` text,
  `P_IDCardStatus` enum('1','2','3','4') DEFAULT '1' COMMENT '1 - Pending,2 - Submitted,3- Approved, 4 - Rejected',
  `P_GuardianName` varchar(100) DEFAULT NULL,
  `P_Gender` enum('1','2','3') DEFAULT NULL COMMENT '1 - Male, 2 - Female, 3 - Others',
  `P_BirthDate` date DEFAULT NULL,
  `P_PermanentBuilding` text,
  `P_PermanentLocality` text,
  `P_PermanentCity` varchar(50) DEFAULT NULL,
  `P_PermanentState` varchar(50) DEFAULT NULL,
  `P_PermanentPincode` varchar(10) DEFAULT NULL,
  `P_PersonalStatus` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 - Pending,2 - Submitted,3- Approved, 4 - Rejected',
  `P_CurrentBuilding` text,
  `P_CurrentLocality` text,
  `P_CurrentCity` varchar(50) DEFAULT NULL,
  `P_CurrentState` varchar(50) DEFAULT NULL,
  `P_CurrentPincode` varchar(10) DEFAULT NULL,
  `P_CurrentStatus` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 - Pending,2 - Submitted,3- Approved, 4 - Rejected',
  `P_TermsStatus` enum('1','2','3') NOT NULL DEFAULT '1' COMMENT '1 = Pending, 2 = Enable, 3 = Disable',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdateDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`VProfileID`),
...
CREATE TABLE `1w_tbl_vendor_works` (
  ...
  `W_WorksGallery` longtext,
  `W_Status` enum('1','2','3') NOT NULL DEFAULT '1' COMMENT '1 = Pending, 2 = Enable, 3 = Disable',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdateDttm` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`VWorkID`),
...
CREATE TABLE `1w_tbl_vendors` (
  ...
  `V_CountryCode` varchar(200) NOT NULL,
  `V_Mobile` varchar(255) NOT NULL,
  `V_Gender` varchar(255) DEFAULT NULL COMMENT '1: Male, 2 : Female',
  `V_CategoryID` int(11) NOT NULL,
  `V_ProfileImage` mediumtext,
  `V_Latitude` varchar(25) NOT NULL,
  `V_Longitude` varchar(25) NOT NULL,
  `V_Address` text,
  `V_Location` text NOT NULL,
  `V_City` varchar(200) NOT NULL,
  `V_Country` varchar(100) DEFAULT NULL,
  `V_VerificationMessage` text,
  `V_ProfileStatus` enum('1','2','3','4') NOT NULL DEFAULT '1',
  `V_VerificationStatus` enum('1','2','3','4') NOT NULL DEFAULT '1' COMMENT '1 - Pending,2 - Submitted,3- Approved, 4 - Rejected',
  `V_Status` enum('1','2','3','4') NOT NULL DEFAULT '2' COMMENT '1: Pending , 2 : Enable, 3 : Disable,4:Mark as Violated',
  `RowAddedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `RowUpdatedDttm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
